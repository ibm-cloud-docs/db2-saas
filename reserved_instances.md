...
If you are using the legacy console, follow the steps outlined below. If you are using the Genius Hub–enabled console, refer to [Configuring a Reserved Instance in the UI](https://cloud.ibm.com/docs/db2-saas?topic=db2-saas-gh_reserved-instances) for the correct steps.
{: important}
