...
-  The default keys are managed by [Key Protect](/docs/key-protect?topic=key-protect-importing-keys). Bring-your-own-key [(BYOK)](/docs/db2-saas?topic=db2-saas-key-management-services) for encryption is also available through Key Protect integration.
