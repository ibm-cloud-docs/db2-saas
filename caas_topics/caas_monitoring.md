...
The Monitoring page brings together high-level performance summaries and detailed operational metrics, helping users quickly assess a database’s current state and investigate performance, availability, or resource-related issues.
